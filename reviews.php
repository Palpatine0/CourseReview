        ...
        <main>
            <div class="container d-flex flex-column align-items-center">
                ...
                <div class="card my-3" style="width: 18rem;">
                    <div class="card-body">
                        This is a very practical course that introduces the basics of programming in a simple and
                        understandable way. The teacher explains clearly, the supporting materials are rich, and it is
                        highly recommended for programming novices.
                    </div>
                </div>
                <div class="card my-3" style="width: 18rem;">
                    <div class="card-body">
                        I mastered the core technology of data analysis through this course. The course content covers a
                        wide range, and the case practice has benefited me a lot and is worth learning.
                    </div>
                </div>
                <div class="card my-3" style="width: 18rem;">
                    <div class="card-body">
                        As a student with a design background, this course opened the door to front-end development for
                        me. The course structure is reasonable, from simple to deep, allowing me to build my own website
                        in a short time.
                    </div>
                </div>
            </div>
